...
// These mirror the server's own slice lengths in app/api/register/route.js. They
// exist client-side so a long answer is stopped where the writer can see it,
// rather than truncated silently after it is sent.
export const FIELD_LIMITS = { name: 120, org: 120, role: 120, city: 120, note: 2000, use: 4000 };
