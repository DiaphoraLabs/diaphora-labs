...
// Every lane strikes the same action. They used to carry six different verbs —
// "Register interest", "Count me in", "Ask a question" — which read as six
// different commitments of six different weights, and made the reader work out
// which one they were agreeing to. The lane already says who you are; the
// button only has to say that you are signing on.
export const LANES = [
  {
    id: 'partner',
    mark: 'danketsu',
  ...
  },
  {
    ...
    done: 'Received, and held in confidence. A person answers this.',
  },
  {
    id: 'media',
    mark: 'transparency',
