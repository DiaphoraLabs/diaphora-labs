...
export const STORY = [
  ...
  },
  {
    ...
    body:
      "Tesla and Westinghouse's polyphase alternating current was proven at Niagara. Stations rose on both sides of the gorge, and transmitting power over distance stopped being a theory.",
  },
  {
    year: '1905–1990s',
    head: 'A working century',
    body:
      'The generators ran for decades, powering the growth of two countries, until the original stations were retired one by one.',
  },
  {
    year: 'Today',
    head: 'The building waits',
    body:
      'The station still stands at the base of the falls — intact, dramatic, and largely unused, beside one of the most visited places on the continent.',
  },
  {
    year: 'Proposed',
...
export const USES = [
  ...
  },
  {
    ...
    body: 'Cafés, events and open space facing the falls, so the campus stays a public place rather than a compound.',
  },
];
...
export const RANGES = [
  ...
  },
  {
    ...
    body: 'GPS-denied robotics in the tailrace tunnel; confined-space and swift-water rescue training.',
  },
  {
